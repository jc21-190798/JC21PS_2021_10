...
public class ParticipantListControllerServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String sql = "SELECT activity_name,user_name FROM trn_activity inner join trn_participant on trn_participant.activity_id = trn_activity.activity_id inner join mst_user on trn_participant.user_id = mst_user.user_id where trn_participant.activity_id = ?;";
